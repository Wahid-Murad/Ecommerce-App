  ...
  Widget build(BuildContext context) {
   ...
   return Scaffold(
                                                      ...
                                                      actions: <Widget>[
                                                        ...
                                                        TextButton(
                                                          ...
                                                          onPressed: () async {
                                                           ...
                                                           await CustomHttpRequest.deleteCategory(category.categoryList[index].id!.toInt());
      ...
      floatingActionButton: _buttonVisiable == true
        ...
        */
                Navigator.push(context,
                        MaterialPageRoute(builder: (context) => AddCategory())).then((value) =>   Provider.of<CategoryProvider>(context).getCategory());
              },
